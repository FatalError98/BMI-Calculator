...
const activeColor = Color.fromRGBO(140, 122, 230, 1);
const inActiveColor = Color.fromARGB(255, 224, 224, 224);

const activeFontColor = Color.fromARGB(255, 224, 224, 224);
const inActiveFontColor = Color.fromRGBO(116, 125, 140, 1);
